...
public class ProdutoRequestDTO {
	...
	// não copiamos o código nem a categoria, tendo em vista que são informados no path da requisição
	@ApiModelProperty(value = "Descrição")
	@NotBlank(message="Descrição") // NotBlank determina e verifica que o campo não pode ser branco e nem nulo
