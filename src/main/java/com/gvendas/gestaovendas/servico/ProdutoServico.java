...
public class ProdutoServico {
	...
	public Produto atualizar(Long codigoCategoria, Long codigoProduto, Produto produto) {
		...
		validarCategoriaDoProdutoExiste(codigoCategoria);
		validarProdutoDuplicado(produto);
		BeanUtils.copyProperties(produto, produtoSalvar, "codigo"); // aqui estamos substituindo o produto do banco de dados "produtoSalvar" pelo o que recebemos "produto" após as validações
