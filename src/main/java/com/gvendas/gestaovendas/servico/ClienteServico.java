...
public class ClienteServico {
	...
	public Cliente atualizar(Long codigo, Cliente cliente) {
		...
		validarClienteDuplicado(cliente);
		BeanUtils.copyProperties(cliente, clienteAtualizar, "codigo");// aqui estamos substituindo os valores existentes(clienteAtualizar) pelos novos (cliente), exceto o código
	...
	private void validarClienteDuplicado(Cliente cliente) {
		...
		if(clientePorNome != null  && clientePorNome.getCodigo() != cliente.getCodigo()) {
			...
			// A exceção será lançada somente se o código for diferente, pois se o código for igual, será uma alteração e será efetivada. 
		}
	}
