...
public class ItemVenda {
	...
	@ManyToOne
	@JoinColumn(name = "codigo_produto", referencedColumnName = "codigo") // aqui estamos estabelecendo o vinculo da foreign key
	private Produto produto;
	
	@ManyToOne
	@JoinColumn(name = "codigo_venda", referencedColumnName = "codigo") // aqui estamos estabelecendo o vinculo da foreign key
	private Venda venda;
