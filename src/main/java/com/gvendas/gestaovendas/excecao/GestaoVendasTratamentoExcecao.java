...
@ControllerAdvice // Essa anotação é como se fosse um listener, sempre que tiver uma exceção, essa
					// classe será verificada para ver se tem um tratamento específico para a
					// exceção
public class GestaoVendasTratamentoExcecao extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		List<Erro> errors = gerarListaDeErros(ex.getBindingResult());// aqui esta pegando o resultado das excecoes que
																		// oocorreu
